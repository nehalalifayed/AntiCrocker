import rule_mod as rule
import preprocess2 as p2
import preprocess as p1
import pandas as pd
#from collections import Counter
import ss 
import who_parser as qparse
import spacy

def grading_module1():
    train_df = pd.read_csv("paragraph1.csv" ,  encoding='latin-1')
    ...
    ###################################################################################################################        
            ...
            #print("the final score1 :" + str(cc / len(s1_list))) 
            if m < 0 :
                m = 0
            elif m >= 0  and m <= 0.39:
                 m = 0
...
reading_scores = grading_module1()
